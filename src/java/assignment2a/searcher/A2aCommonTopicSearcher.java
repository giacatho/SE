 ...
 * @author nguyentritin
 */
public class A2aCommonTopicSearcher {
	private final IndexReader reader;
	private final IndexSearcher searcher;
			
	public A2aCommonTopicSearcher() throws IOException {
	...
	public void searchCommonTopic(String year) throws IOException, ParseException {
		...
		Map<String, Integer> termFrequencyMap = Utils.getTermFrequencies(this.reader, document.doc, true, null);
	...
	public static void main(String[] args) throws IOException, ParseException {
		A2aCommonTopicSearcher searcher = new A2aCommonTopicSearcher();
